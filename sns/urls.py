...
urlpatterns = [
    ...
    path('search/post/tag/', views.PostList_linking_tag.as_view(), name="postlist_linking_tag"),
    ...
    path('soudan/tag/', views.QuestionList_linking_tag.as_view(), name="questionlist_linking_tag"),
    # path('soudan/tag/<tag_word>/', views.questionlist_linking_tag, name="questionlist_linking_tag"),
